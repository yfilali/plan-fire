...
export default function AppearanceSettings() {
	...
	return (
		<Card>
			<CardHeader icon="🎨" title="Appearance" subtitle="How Firely looks and formats numbers." />
			...
			<SettingRow S={S} title="Default landing tab" desc="Where Firely opens when you launch it." last>
