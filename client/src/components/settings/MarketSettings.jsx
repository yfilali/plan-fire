...
import { Card, CardHeader, Segmented, Badge } from "../ui.jsx";
...
export default function MarketSettings() {
	...
	return (
		<Card>
				...
				right={
					<Segmented
						...
						options={[
							...
							{ value: "historical_period", label: pro ? "🕰 Time Machine" : "🔒 Time Machine", color: S.blue },
						]}
					/>
				}
			/>
			...
			{isPeriod ? (
				<div style={{ marginBottom: 16 }}>
					<div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
						<span style={{ fontSize: 13, fontWeight: 650, color: S.text }}>Replay a real market era</span>
			...
			<div className="col-2">
				<SliderRow label={isPeriod ? "Steady return (after the era)" : "Nominal return"} value={nomReturn} onChange={setNomReturn} min={0} max={0.15} step={0.0025} editScale={100} editMax={0.5} format={(v) => `${(v * 100).toFixed(2)}%`} />
