...
export default function Copilot() {
	...
	if (!isPro) {
		return (
			<>
				<Card>
					<CardHeader icon={<Icon name="sparkle" size={16} color={S.accent} />} title="PlanFire Co-pilot" subtitle="An AI planner that reads your real numbers and can edit your plan for you." />
					<div style={{ textAlign: "center", padding: "24px 8px" }}>
						...
						<div style={{ fontSize: FS.base, color: S.textMuted, marginTop: 6, maxWidth: 420, marginInline: "auto", lineHeight: 1.5 }}>
							"Can I retire at 52?" — the co-pilot answers with <em>your</em> figures and proposes one-tap changes you can apply. Available on PlanFire Pro.
						</div>
	...
	return (
		<Card pad={0} style={{ display: "flex", flexDirection: "column", height: "calc(100vh - 150px)", minHeight: 460 }}>
			<div style={{ padding: "16px 18px", borderBottom: `1px solid ${S.border}` }}>
				<CardHeader icon={<Icon name="sparkle" size={16} color={S.accent} />} title="PlanFire Co-pilot" subtitle="Grounded in your live plan — it can propose changes you apply with one tap." />
			</div>
